...
const camera = new THREE.PerspectiveCamera(45, window.innerWidth / window.innerHeight, 0.1, 21200);
...
//ArnalA
//chassisBody.position.set(100,2.7,-205)
chassisBody.position.set(-26,4,-5)
...
var material = new THREE.MeshBasicMaterial({
  map: new THREE.TextureLoader().load('./img/Floors.png')
...
var material = new THREE.MeshBasicMaterial({
  map: new THREE.TextureLoader().load('./img/images (14).png')
...
var material = new THREE.MeshBasicMaterial({
  map: new THREE.TextureLoader().load('./img/images (1).png')
...
var material = new THREE.MeshBasicMaterial({
  map: new THREE.TextureLoader().load('./img/images (12).png')
...
const J7 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(-20, -3, 20)
})
...
const J10 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(23, -4, 30)
})
...
const J11 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(40, -2.9, 50)
})
...
const J21 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(110,0.03, -70)
})
...
//_____343
var geometry = new THREE.BoxGeometry(250,100,250);
var material = new THREE.MeshLambertMaterial({
  map: new THREE.TextureLoader().load('./img/images (12).png'),
...
const jamin343 = new CANNON.Box(new CANNON.Vec3(125, 50.7,125));
const J343 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(126,-50, -177)
})
J343.quaternion.setFromEuler(0,0,-0);
J343.addShape(jamin343)
world.addBody(J343)

//_____344
var geometry = new THREE.BoxGeometry(100.5, 100,100.5);
var material = new THREE.MeshLambertMaterial({
  map: new THREE.TextureLoader().load('./img/images (14).png'),
...
const jamin344 = new CANNON.Box(new CANNON.Vec3(50, 50.3,50));
const J344 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(192,-51,32)
})
J344.quaternion.setFromEuler(-0.03,-0,0.1);
...
//_____347
var geometry = new THREE.BoxGeometry(18, 5.02, 15);
var material = new THREE.MeshLambertMaterial({
  map: new THREE.TextureLoader().load('./img/images (1).png'),
...
const jamin347 = new CANNON.Box(new CANNON.Vec3(9, 2.7,7.5));
const J347 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(-28, -0.7,6)
})
J347.quaternion.setFromEuler(0, 0, -0);
...
//_____348
var geometry = new THREE.BoxGeometry(30, 5.01, 30);
var material = new THREE.MeshLambertMaterial({
  map: new THREE.TextureLoader().load('./img/images (1).png'),
...
const jamin348 = new CANNON.Box(new CANNON.Vec3(15,2.7,15));
const J348 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(-8, -0.7,-12)
})
J348.quaternion.setFromEuler(0, 0, -0);
...
const jamin349 = new CANNON.Box(new CANNON.Vec3(9, 2.7, 7.5));
const J349 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(-43, -0.8, 6.1)
})
J349.quaternion.setFromEuler(0, 0, -0);
...
const jamin350= new CANNON.Box(new CANNON.Vec3(7.5,2.7,2.5));
const J350 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(110.7,0.8, -84)
})
J350.quaternion.setFromEuler(0,0,-0.1);
J350.addShape(jamin350);
world.addBody(J350);

//___351
var geometry = new THREE.BoxGeometry(15.2, 4.9, 6);
var material = new THREE.MeshBasicMaterial({
  map: new THREE.TextureLoader().load('./img/images (12).png')
...
const jamin351 = new CANNON.Box(new CANNON.Vec3(7.5, 2.7, 3));
const J351 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(110.7, 0.8, -84)
})
J351.quaternion.setFromEuler(0, 0, -0.1);
...
const jamin352 = new CANNON.Box(new CANNON.Vec3(5, 2.7, 3));
const J352 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(120, -0.2, -84)
})
J352.quaternion.setFromEuler(0, 0, -0.1);
J352.addShape(jamin352);
world.addBody(J352);


//___353
var geometry = new THREE.BoxGeometry(10, 4.9, 6.2);
var material = new THREE.MeshBasicMaterial({
  map: new THREE.TextureLoader().load('./img/images (12).png')
...
const jamin353 = new CANNON.Box(new CANNON.Vec3(5, 2.7, 3));
const J353 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(120, -0.2, -84)
})
J353.quaternion.setFromEuler(0, 0, -0.1);
...
const jamin354 = new CANNON.Box(new CANNON.Vec3(5, 2.7,2.5));
const J354 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(98.7, 1.6, -84)
})
J354.quaternion.setFromEuler(0, 0, -0.01);
...
//___355
var geometry = new THREE.BoxGeometry(10, 4.9, 6.01);
var material = new THREE.MeshBasicMaterial({
  map: new THREE.TextureLoader().load('./img/images (12).png')
...
const jamin355 = new CANNON.Box(new CANNON.Vec3(5, 2.7,3));
const J355 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(98.7, 1.6, -84)
})
J355.quaternion.setFromEuler(0, 0, -0.01);
...
const jamin356 = new CANNON.Box(new CANNON.Vec3(5, 2.7,2.5));
const J356 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(98.7, 1.6, -84)
})
J356.quaternion.setFromEuler(0, -0.6, -0.1);
J356.addShape(jamin356);
world.addBody(J356);


//___357
var geometry = new THREE.BoxGeometry(10.1, 4.9, 6.01);
var material = new THREE.MeshBasicMaterial({
  map: new THREE.TextureLoader().load('./img/images (12).png')
...
const jamin357 = new CANNON.Box(new CANNON.Vec3(5, 2.7,3));
const J357 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(98.7, 1.6, -84)
})
J357.quaternion.setFromEuler(0, -0.6, -0.1);
...
const jamin358 = new CANNON.Box(new CANNON.Vec3(2.5, 2.7,5));
const J358 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(92, 2.1, -90)
})
J358.quaternion.setFromEuler(0, 0.6, -0.07);
...
const jamin359 = new CANNON.Box(new CANNON.Vec3(2.5, 2.7,7.5));
const J359 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(95, 2.8, -110)
})
J359.quaternion.setFromEuler(0, -0, -0);
J359.addShape(jamin359);
world.addBody(J359);


//___360
var geometry = new THREE.BoxGeometry(5.1, 5, 15.1);
var material = new THREE.MeshBasicMaterial({
  map: new THREE.TextureLoader().load('./img/images (12).png')
...
const jamin360 = new CANNON.Box(new CANNON.Vec3(2.5, 2.7,7.5));
const J360 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(95, 2.8, -110)
})
J360.quaternion.setFromEuler(0, -0, -0);
...
const jamin361 = new CANNON.Box(new CANNON.Vec3(2.5, 2.7,7.5));
const J361 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(92.7, 2.8, -122.2)
})
J361.quaternion.setFromEuler(0, 0.4, -0);
...
const jamin362 = new CANNON.Box(new CANNON.Vec3(2.5, 2.7,7.5));
const J362 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(85, 1.4, -137)
})
J362.quaternion.setFromEuler(-0.1, 0.6, -0);
...
const jamin363 = new CANNON.Box(new CANNON.Vec3(2.5, 2.7,7.5));
const J363 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(85, 1.4, -137)
})
J363.quaternion.setFromEuler(-0.1, 0.6, -0);
...
const jamin364 = new CANNON.Box(new CANNON.Vec3(2.5, 2.7,7.5));
const J364 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(87, 2, -120)
})
J364.quaternion.setFromEuler(0.1, 0.4, 0.2);
...
const jamin365 = new CANNON.Box(new CANNON.Vec3(2.5, 2.7,7.5));
const J365 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(87, 2.5, -123)
})
J365.quaternion.setFromEuler(-0.1, 0.4, 0.2);
...
const jamin366 = new CANNON.Box(new CANNON.Vec3(2.5, 2.7, 7.5));
const J366 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(97, 2, -123)
})
J366.quaternion.setFromEuler(-0.2, 0.5, 0.3);
...
const jamin367 = new CANNON.Box(new CANNON.Vec3(2.5, 2.7, 7.5));
const J367 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(97, 2, -130)
})
J367.quaternion.setFromEuler(-0.2, 0.5, -0.3);
...
const jamin368 = new CANNON.Box(new CANNON.Vec3(2.5, 2.7, 7.5));
const J368 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(99, 1.6, -95)
})
J368.quaternion.setFromEuler(-0.1, 0.5, -0.3);
...
const jamin369 = new CANNON.Box(new CANNON.Vec3(2.7, 2.7, 7.7));
const J369 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(104, 2.9, -98)
})
J369.quaternion.setFromEuler(-0.1, 0, 0.1);
...
const jamin370 = new CANNON.Box(new CANNON.Vec3(2.5, 2.7,5));
const J370 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(73, -0.3, -151)
})
J370.quaternion.setFromEuler(-0.5,1.2,-0.4);
...
const jamin371 = new CANNON.Box(new CANNON.Vec3(2.5, 2.7,5));
const J371 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(73, -0.2, -142)
})
J371.quaternion.setFromEuler(-0.5,1.2,-0.4);
J371.addShape(jamin371);
world.addBody(J371);


//___372
var geometry = new THREE.BoxGeometry(150,100,150);
var material = new THREE.MeshBasicMaterial({
  map: new THREE.TextureLoader().load('./img/images (14).png')
...
const jamin372 = new CANNON.Box(new CANNON.Vec3(75,50.7,75));
const J372 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(-76, -50.2, -121)
})
//J372.quaternion.setFromEuler(-0.5,1.2,-0.4);
...
//___373
var geometry = new THREE.BoxGeometry(15,3,5);
var material = new THREE.MeshBasicMaterial({
  map: new THREE.TextureLoader().load('./img/images (12).png')
...
const jamin373 = new CANNON.Box(new CANNON.Vec3(7.5,1.7,2.5));
const J373 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(158.4,1.3,-84)
})
J373.quaternion.setFromEuler(0,0,-0.1);
J373.addShape(jamin373);
world.addBody(J373);


//___374
var geometry = new THREE.BoxGeometry(15,3.01,4.9);
var material = new THREE.MeshBasicMaterial({
  map: new THREE.TextureLoader().load('./img/images (1).png')
...
const jamin374 = new CANNON.Box(new CANNON.Vec3(7.5,1.7,2.5));
const J374 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(158.4,1.3,-84)
})
J374.quaternion.setFromEuler(0,0,-0.1);
...
const jamin375 = new CANNON.Box(new CANNON.Vec3(7.5,1.7,2.5));
const J375 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(143.9,1.3,-84)
})
J375.quaternion.setFromEuler(0,0,0.1);
J375.addShape(jamin375);
world.addBody(J375);


//___376
var geometry = new THREE.BoxGeometry(15.01,3.01,4.9);
var material = new THREE.MeshBasicMaterial({
  map: new THREE.TextureLoader().load('./img/images (1).png')
...
const jamin376 = new CANNON.Box(new CANNON.Vec3(7.5,1.7,2.5));
const J376 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(143.9,1.3,-84)
})
J376.quaternion.setFromEuler(0,0,0.1);
...
var geometry = new THREE.SphereGeometry(70);
var material = new THREE.MeshBasicMaterial({
  map: new THREE.TextureLoader().load('./img/grass.webp')
});
...
const S110 = new CANNON.Body({
  mass: 0,
  shape: new CANNON.Sphere(50.2),
  position: new CANNON.Vec3(-97, -39, -140)
})
...
const S111 = new CANNON.Body({
  mass: 0,
  shape: new CANNON.Sphere(50.2),
  position: new CANNON.Vec3(-75, -44, -130)
})
...
const S112 = new CANNON.Body({
  mass: 0,
  shape: new CANNON.Sphere(50.2),
  position: new CANNON.Vec3(-107, -43.5, -105)
})
...
const S113 = new CANNON.Body({
  mass: 0,
  shape: new CANNON.Sphere(50.2),
  position: new CANNON.Vec3(258,-48, -80)
})
...
const S114 = new CANNON.Body({
  mass: 0,
  shape: new CANNON.Sphere(50.2),
  position: new CANNON.Vec3(258,-45, -115)
})
...
const S116 = new CANNON.Body({
  mass: 0,
  shape: new CANNON.Sphere(50.2),
  position: new CANNON.Vec3(10, -40, -160)
})
...
const S117 = new CANNON.Body({
  mass: 0,
  shape: new CANNON.Sphere(50.2),
  position: new CANNON.Vec3(238, -42, -135)
})
...
const S118 = new CANNON.Body({
  mass: 0,
  shape: new CANNON.Sphere(50.2),
  position: new CANNON.Vec3(229, -49, -55)
})
...
const S119 = new CANNON.Body({
  mass: 0,
  shape: new CANNON.Sphere(50.2),
  position: new CANNON.Vec3(221, -43.7, -125)
})
...
const S120 = new CANNON.Body({
  mass: 0,
  shape: new CANNON.Sphere(50.2),
  position: new CANNON.Vec3(170, -44, -115)
})
...
const S121 = new CANNON.Body({
  mass: 0,
  shape: new CANNON.Sphere(50.2),
  position: new CANNON.Vec3(190, -40, -125)
})
...
// ho1
const hou1 = new CANNON.Box(new CANNON.Vec3(3.8,5,5));
const ho1 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(13,6.6,2)
})
ho1.quaternion.setFromEuler(0, 0, 0);
ho1.addShape(hou1)
world.addBody(ho1)

// ho2
const hou2 = new CANNON.Box(new CANNON.Vec3(8.3,5,5.7));
const ho2 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(-27.8,6.6,7.8)
})
ho2.quaternion.setFromEuler(0, 0, 0);
ho2.addShape(hou2)
world.addBody(ho2)

// ho3
const hou3 = new CANNON.Box(new CANNON.Vec3(1.2, 5,1));
const ho3 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(-40, 2, -31)
})
ho3.quaternion.setFromEuler(0, 0, 0);
ho3.addShape(hou3)
world.addBody(ho3)


// ho4
const hou4 = new CANNON.Box(new CANNON.Vec3(2.3, 5,2));
const ho4 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(-40, 6.6, -35)
})
ho4.quaternion.setFromEuler(0, 0, 0);
ho4.addShape(hou4)
world.addBody(ho4)


// ho5
const hou5 = new CANNON.Box(new CANNON.Vec3(8.3, 5,5));
const ho5 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(180, 6.6, -55)
})
ho5.quaternion.setFromEuler(0, 0, 0);
ho5.addShape(hou5)
world.addBody(ho5)


// ho6
const hou6 = new CANNON.Box(new CANNON.Vec3(5.4, 5,8));
const ho6 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(199.7, 6.6, -59.3)
})
ho6.quaternion.setFromEuler(0, 0, 0);
ho6.addShape(hou6)
world.addBody(ho6)


// ho7
const hou7 = new CANNON.Box(new CANNON.Vec3(8.2, 5,5.7));
const ho7 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(95.9, 6.6, -225)
})
ho7.quaternion.setFromEuler(0, 0, 0);
ho7.addShape(hou7)
world.addBody(ho7)


// ho8
const hou8 = new CANNON.Box(new CANNON.Vec3(5.5, 5,8));
const ho8 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(96.4, 6.6, -180)
})
ho8.quaternion.setFromEuler(0, 0, 0);
ho8.addShape(hou8)
world.addBody(ho8)
...
if (!collided) {
  ...
  if (checkCollision(cube1,mesh)) {
    ...
    window.location.href = "./level1.html"; // Ya window.open("https://example.com");
    console.log('one')
  }
}
